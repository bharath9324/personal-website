    ...
    <main className="flex flex-col items-center justify-center bg-gray-100 text-gray-900 px-4">
      <div id="main-body">
        <div className="max-w-xl text-center">
          ...
          <div className="p-4 bg-gray-100 max-w-sm overflow-hidden ">
            <ul>
          ...
          <div className="p-4 bg-gray-100 max-w-sm overflow-hidden "> M.Math - Computer Science </div>
          <div className="p-4 bg-gray-100 max-w-sm overflow-hidden "> Relevant Courses: CS 898 Deep Learning, CS 889 Human Computer Interaction, CS 698 Machine Learning </div>
          ...
          <div className="p-4 bg-gray-100 max-w-sm overflow-hidden "> B.Tech - Computer Science and Engineering </div>
        </div>
      </div>
      <Footer/>
    </main>
